...
from ..schema import addresses

def fetchLocations(conn, user_id:int):
    statement = select(
...
def addLocation(conn, user_id:int, location:str):
...
def updateLocation(conn, user_id:int, location:str, address_id:int):
...
def deleteLocation(conn, user_id:int, address_id:int):
